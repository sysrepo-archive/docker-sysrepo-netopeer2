...
$SNABBPATH/snabb lwaftr bench -b /dev/stdout $SNABBPATH/program/lwaftr/tests/data/icmp_on_fail.conf $SNABBPATH/program/lwaftr/tests/benchdata/ipv{4,6}-0550.pcap
